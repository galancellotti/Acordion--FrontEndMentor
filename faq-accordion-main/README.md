# Mentor Frontend - FAQ acordeão

![Visualização do design para o desafio de codificação acordeão de perguntas frequentes](./design/desktop-preview.jpg)
...
Seu desafio é construir este acordeão de FAQ e fazer com que pareça o mais próximo possível do design.
...
Sinta-se à vontade para usar qualquer fluxo de trabalho que seja confortável. Abaixo está um processo sugerido, mas não é necessário seguir estas etapas:

1. Inicialize seu projeto como um repositório público no [GitHub](https://github.com/). A criação de um repositório será mais fácil de compartilhar seu código com a comunidade se você precisar de ajuda. Se você não tiver certeza de como fazer isso, [leia este recurso Try Git](https://try.github.io/).
...
3. Analise os projetos para começar a planejar como você abordará o projeto. Esta etapa é crucial para ajudá-lo a pensar no futuro para que as classes CSS criem estilos reutilizáveis.
...
6. Comece a adicionar estilos ao topo da página e vá descendo. Só passe para a próxima seção quando estiver satisfeito por concluir a área em que está trabalhando.
...
Envie sua solução na plataforma para que o resto da comunidade veja. Siga nosso ["Guia completo para envio de soluções"](https://medium.com/frontend-mentor/a-complete-guide-to-submitting-solutions-on-frontend-mentor-ac